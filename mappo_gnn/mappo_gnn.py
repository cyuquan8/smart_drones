            ...
            for _ in range(self.num_epochs):
                ...
                for batch in batches:
                    ...
                    if self.grad_clipping == True:
                        ...
                        actor_grad_norm = T.nn.utils.clip_grad_norm_(agent.mappo_gnn_actor.parameters(), max_norm = self.grad_norm_clip, norm_type = 2, error_if_nonfinite = True)
                    ...
                    if self.grad_clipping == True:
                        ...
                        # gradient norm clipping for critic model
                        critic_grad_norm = T.nn.utils.clip_grad_norm_(agent.mappo_gnn_critic.parameters(), max_norm = self.grad_norm_clip, norm_type = 2, error_if_nonfinite = True)
