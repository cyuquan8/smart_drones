# ==========================================================================================================================================================
# maddpgv2 gnn replay buffer class
...
import math
import numpy as np
from utils.utils import gnn_goal_replay_buffer

class maddpgv2_gnn_replay_buffer:
    ...
    def __init__(self, mem_size, num_agents, u_actions_dims, c_actions_dims, actor_input_dims, goal_dims, num_of_add_goals, goal_strategy, is_adversary, ep_time_limit, r_rad, big_rew_cnst, 
        ...
        self.org_replay_buffer = gnn_goal_replay_buffer(mem_size = mem_size, num_agents = num_agents, u_actions_dims = u_actions_dims, c_actions_dims = c_actions_dims, 
                                                        actor_input_dims = actor_input_dims, goal_dims = goal_dims)

        # iterate over additional goals
        for i in range(self.num_of_add_goals):

            self.add_goals_replay_buffer_list.append(gnn_goal_replay_buffer(mem_size = mem_size, num_agents = num_agents, u_actions_dims = u_actions_dims, c_actions_dims = c_actions_dims, 
                                                                            actor_input_dims = actor_input_dims, goal_dims = goal_dims))
